...
export class Vec2 extends Float32Array {
   ...
   * @returns `out`
   */
  /*static transformMat2(out: Vec2Like, a: Readonly<Vec2Like>, m: ReadonlyMat2): Vec2Like {
    const x = a[0];
    const y = a[1];
    out[0] = m[0] * x + m[2] * y;
    out[1] = m[1] * x + m[3] * y;
   ...
   * @returns `out`
   */
  /*static transformMat2d(out: Vec2Like, a: Readonly<Vec2Like>, m: ReadonlyMat2d): Vec2Like {
    const x = a[0];
    const y = a[1];
   ...
   * @returns `out`
   */
  /*static transformMat3(out: Vec2Like, a: Readonly<Vec2Like>, m: ReadonlyMat3): Vec2Like {
    const x = a[0];
    const y = a[1];
   ...
   * @returns `out`
   */
  /*static transformMat4(out: Vec2Like, a: Readonly<Vec2Like>, m: ReadonlyMat4): Vec2Like {
    const x = a[0];
    const y = a[1];
   ...
   * v.xyy // returns new Vec3(0, 1, 1);
   * v.yyxy // returns new Vec4(1, 1, 0, 1);
   *
   * v.rg // returns new Vec2(0, 1);
   * v.rgg // returns new Vec3(0, 1, 1);
