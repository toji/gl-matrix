...
(function (global, factory) {
      ...
      return _createClass(X, [{
        ...
        value: function fromQuat(e, t) {
          var n = t[0],
            ...
            m = i * c,
            R = i * d;
          return e[0] = 1 - k - M, e[3] = L - R, e[6] = y + m, e[1] = L + R, e[4] = 1 - l - M, e[7] = h - T, e[2] = y - m, e[5] = h + T, e[8] = 1 - l - k, e;
        }
      }, {
        key: "fromMat4",
    ...
    A = /*#__PURE__*/function (_Float64Array4) {
      ...
      return _createClass(A, [{
        ...
        value: function invert(e, t) {
          ...
          return N ? (N = 1 / N, e[0] = (c * O - d * P + l * Y) * N, e[1] = (r * P - s * O - i * Y) * N, e[2] = (T * I - m * p + R * V) * N, e[3] = (y * p - k * I - h * V) * N, e[4] = (d * z - a * O - l * S) * N, e[5] = (n * O - r * z + i * S) * N, e[6] = (m * b - M * I - R * o) * N, e[7] = (L * I - y * b + h * o) * N, e[8] = (a * P - c * z + l * D) * N, e[9] = (s * z - n * P - i * D) * N, e[10] = (M * p - T * b + R * x) * N, e[11] = (k * b - L * p - h * x) * N, e[12] = (c * S - a * Y - d * D) * N, e[13] = (n * Y - s * S + r * D) * N, e[14] = (T * o - M * V - m * x) * N, e[15] = (L * V - k * o + y * x) * N, e) : null;
        }
      }, {
        key: "adjoint",
        value: function adjoint(e, t) {
          var n = t[0],
            ...
            P = k * R - h * T,
            O = y * R - h * m;
          return e[0] = c * O - d * P + l * Y, e[1] = r * P - s * O - i * Y, e[2] = T * I - m * p + R * V, e[3] = y * p - k * I - h * V, e[4] = d * z - a * O - l * S, e[5] = n * O - r * z + i * S, e[6] = m * b - M * I - R * o, e[7] = L * I - y * b + h * o, e[8] = a * P - c * z + l * D, e[9] = s * z - n * P - i * D, e[10] = M * p - T * b + R * x, e[11] = k * b - L * p - h * x, e[12] = c * S - a * Y - d * D, e[13] = n * Y - s * S + r * D, e[14] = T * o - M * V - m * x, e[15] = L * V - k * o + y * x, e;
        }
      }, {
        key: "determinant",
        value: function determinant(e) {
        ...
        value: function translate(e, t, n) {
          ...
          if (t === e) e[12] = t[0] * s + t[4] * r + t[8] * i + t[12], e[13] = t[1] * s + t[5] * r + t[9] * i + t[13], e[14] = t[2] * s + t[6] * r + t[10] * i + t[14], e[15] = t[3] * s + t[7] * r + t[11] * i + t[15];else {
            var a = t[0],
              ...
              m = t[10],
              R = t[11];
            e[0] = a, e[1] = c, e[2] = d, e[3] = l, e[4] = L, e[5] = k, e[6] = y, e[7] = h, e[8] = M, e[9] = T, e[10] = m, e[11] = R, e[12] = a * s + L * r + M * i + t[12], e[13] = c * s + k * r + T * i + t[13], e[14] = d * s + y * r + m * i + t[14], e[15] = l * s + h * r + R * i + t[15];
          }
          return e;
        }
      }, {
        ...
        value: function rotate(e, t, n, s) {
          ...
          var d = Math.sin(n),
            ...
            N = i * a * L - r * d,
            v = a * a * L + l;
          return e[0] = k * I + T * D + o * S, e[1] = y * I + m * D + b * S, e[2] = h * I + R * D + V * S, e[3] = M * I + x * D + p * S, e[4] = k * z + T * Y + o * P, e[5] = y * z + m * Y + b * P, e[6] = h * z + R * Y + V * P, e[7] = M * z + x * Y + p * P, e[8] = k * O + T * N + o * v, e[9] = y * O + m * N + b * v, e[10] = h * O + R * N + V * v, e[11] = M * O + x * N + p * v, t !== e && (e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e;
        }
      }, {
        key: "rotateX",
        ...
        value: function fromRotationTranslation(e, t, n) {
          var s = t[0],
            ...
            R = a * d,
            x = a * l;
          return e[0] = 1 - (h + T), e[1] = k + x, e[2] = y - R, e[3] = 0, e[4] = k - x, e[5] = 1 - (L + T), e[6] = M + m, e[7] = 0, e[8] = y + R, e[9] = M - m, e[10] = 1 - (L + h), e[11] = 0, e[12] = n[0], e[13] = n[1], e[14] = n[2], e[15] = 1, e;
        }
      }, {
        key: "fromQuat2",
        ...
        value: function fromRotationTranslationScale(e, t, n, s) {
          var r = t[0],
            ...
            V = s[1],
            p = s[2];
          return e[0] = (1 - (M + m)) * b, e[1] = (y + o) * b, e[2] = (h - x) * b, e[3] = 0, e[4] = (y - o) * V, e[5] = (1 - (k + m)) * V, e[6] = (T + R) * V, e[7] = 0, e[8] = (h + x) * p, e[9] = (T - R) * p, e[10] = (1 - (k + M)) * p, e[11] = 0, e[12] = n[0], e[13] = n[1], e[14] = n[2], e[15] = 1, e;
        }
      }, {
        ...
        value: function fromQuat(e, t) {
          var n = t[0],
            ...
            m = i * c,
            R = i * d;
          return e[0] = 1 - k - M, e[1] = L + R, e[2] = y - m, e[3] = 0, e[4] = L - R, e[5] = 1 - l - M, e[6] = h + T, e[7] = 0, e[8] = y + m, e[9] = h - T, e[10] = 1 - l - k, e[11] = 0, e[12] = 0, e[13] = 0, e[14] = 0, e[15] = 1, e;
        }
      }, {
        key: "frustumNO",
        ...
        value: function lookAt(e, t, n, s) {
          var r = t[0],
            ...
            k = n[1],
            y = n[2];
          if (Math.abs(r - L) < 1e-6 && Math.abs(i - k) < 1e-6 && Math.abs(a - y) < 1e-6) return A.identity(e);
          var h = r - L,
            M = i - k,
            T = a - y,
          ...
          var b = M * o - T * x,
            V = T * R - h * o,
            p = h * x - M * R;
          return m = Math.sqrt(b * b + V * V + p * p), m ? (m = 1 / m, b *= m, V *= m, p *= m) : (b = 0, V = 0, p = 0), e[0] = R, e[1] = b, e[2] = h, e[3] = 0, e[4] = x, e[5] = V, e[6] = M, e[7] = 0, e[8] = o, e[9] = p, e[10] = T, e[11] = 0, e[12] = -(R * r + x * i + o * a), e[13] = -(b * r + V * i + p * a), e[14] = -(h * r + M * i + T * a), e[15] = 1, e;
        }
      }, {
        key: "targetTo",
  ...
  q.len = q.magnitude;
  var ye = new Float64Array([0, 0, 0, 1]),
    Le,
    ae,
    ce,
    U,
    ...
    Q = /*#__PURE__*/function (_Float64Array7) {
      ...
      return _createClass(Q, [{
        ...
        value: function rotationTo(e, t, n) {
          var s = E.dot(t, n);
          return s < -.999999 ? (E.cross(f(Q, W), f(Q, ke), t), E.mag(f(Q, W)) < 1e-6 && E.cross(f(Q, W), f(Q, he), t), E.normalize(f(Q, W), f(Q, W)), Q.setAxisAngle(e, f(Q, W), Math.PI), e) : s > .999999 ? (e[0] = 0, e[1] = 0, e[2] = 0, e[3] = 1, e) : (E.cross(f(Q, W), t, n), e[0] = f(Q, W)[0], e[1] = f(Q, W)[1], e[2] = f(Q, W)[2], e[3] = 1 + s, Q.normalize(e, e));
        }
      }, {
        key: "sqlerp",
  ...
  Le = new WeakMap(), ae = new WeakMap(), ce = new WeakMap(), U = new WeakMap(), W = new WeakMap(), ke = new WeakMap(), he = new WeakMap(), G(Q, Le, "zyx"), G(Q, ae, new Float64Array(4)), G(Q, ce, new Float64Array(4)), G(Q, U, new Float64Array(9)), G(Q, W, new Float64Array(3)), G(Q, ke, new Float64Array([1, 0, 0])), G(Q, he, new Float64Array([0, 1, 0]));
  var F = Q;
  F.set = q.set;
  F.add = q.add;
  F.lerp = q.lerp;
      ...
      return _createClass(Z, [{
        ...
        value: function rotateX(e, t, n) {
          var s = -t[0],
            ...
            h = l * a + L * i + c * r - d * s,
            M = L * a - c * s - d * r - l * i;
          return F.rotateX(e, t, n), s = e[0], r = e[1], i = e[2], a = e[3], e[4] = k * a + M * s + y * i - h * r, e[5] = y * a + M * r + h * s - k * i, e[6] = h * a + M * i + k * r - y * s, e[7] = M * a - k * s - y * r - h * i, e;
        }
      }, {
        key: "rotateY",
        value: function rotateY(e, t, n) {
          var s = -t[0],
            ...
            h = l * a + L * i + c * r - d * s,
            M = L * a - c * s - d * r - l * i;
          return F.rotateY(e, t, n), s = e[0], r = e[1], i = e[2], a = e[3], e[4] = k * a + M * s + y * i - h * r, e[5] = y * a + M * r + h * s - k * i, e[6] = h * a + M * i + k * r - y * s, e[7] = M * a - k * s - y * r - h * i, e;
        }
      }, {
        key: "rotateZ",
        value: function rotateZ(e, t, n) {
          var s = -t[0],
            ...
            h = l * a + L * i + c * r - d * s,
            M = L * a - c * s - d * r - l * i;
          return F.rotateZ(e, t, n), s = e[0], r = e[1], i = e[2], a = e[3], e[4] = k * a + M * s + y * i - h * r, e[5] = y * a + M * r + h * s - k * i, e[6] = h * a + M * i + k * r - y * s, e[7] = M * a - k * s - y * r - h * i, e;
        }
      }, {
        ...
        value: function multiply(e, t, n) {
          var s = t[0],
            ...
            R = n[2],
            x = n[3];
          return e[0] = s * x + a * T + r * R - i * m, e[1] = r * x + a * m + i * T - s * R, e[2] = i * x + a * R + s * m - r * T, e[3] = a * x - s * T - r * m - i * R, e[4] = s * L + a * c + r * l - i * d + k * x + M * T + y * R - h * m, e[5] = r * L + a * d + i * c - s * l + y * x + M * m + h * T - k * R, e[6] = i * L + a * l + s * d - r * c + h * x + M * R + k * m - y * T, e[7] = a * L - s * c - r * d - i * l + M * x - k * T - y * m - h * R, e;
        }
      }, {
        key: "mul",
        value: function mul(e, t, n) {
