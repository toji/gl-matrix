...
(function (global, factory) {
      ...
      return _createClass(X, [{
        ...
        value: function fromQuat(e, t) {
          var n = t[0],
            ...
            m = i * c,
            o = i * d;
          return e[0] = 1 - h - M, e[3] = L - o, e[6] = k + m, e[1] = L + o, e[4] = 1 - l - M, e[7] = y - T, e[2] = k - m, e[5] = y + T, e[8] = 1 - l - h, e;
        }
      }, {
        key: "fromMat4",
    ...
    E = /*#__PURE__*/function (_Float32Array4) {
      ...
      return _createClass(E, [{
        ...
        value: function invert(e, t) {
          ...
          return N ? (N = 1 / N, e[0] = (c * O - d * P + l * Y) * N, e[1] = (r * P - s * O - i * Y) * N, e[2] = (T * I - m * p + o * V) * N, e[3] = (k * p - h * I - y * V) * N, e[4] = (d * z - a * O - l * S) * N, e[5] = (n * O - r * z + i * S) * N, e[6] = (m * b - M * I - o * R) * N, e[7] = (L * I - k * b + y * R) * N, e[8] = (a * P - c * z + l * F) * N, e[9] = (s * z - n * P - i * F) * N, e[10] = (M * p - T * b + o * x) * N, e[11] = (h * b - L * p - y * x) * N, e[12] = (c * S - a * Y - d * F) * N, e[13] = (n * Y - s * S + r * F) * N, e[14] = (T * R - M * V - m * x) * N, e[15] = (L * V - h * R + k * x) * N, e) : null;
        }
      }, {
        key: "adjoint",
        value: function adjoint(e, t) {
          var n = t[0],
            ...
            P = h * o - y * T,
            O = k * o - y * m;
          return e[0] = c * O - d * P + l * Y, e[1] = r * P - s * O - i * Y, e[2] = T * I - m * p + o * V, e[3] = k * p - h * I - y * V, e[4] = d * z - a * O - l * S, e[5] = n * O - r * z + i * S, e[6] = m * b - M * I - o * R, e[7] = L * I - k * b + y * R, e[8] = a * P - c * z + l * F, e[9] = s * z - n * P - i * F, e[10] = M * p - T * b + o * x, e[11] = h * b - L * p - y * x, e[12] = c * S - a * Y - d * F, e[13] = n * Y - s * S + r * F, e[14] = T * R - M * V - m * x, e[15] = L * V - h * R + k * x, e;
        }
      }, {
        key: "determinant",
        value: function determinant(e) {
        ...
        value: function multiply(e, t, n) {
          var s = t[0],
            ...
            V = n[2],
            p = n[3];
          return e[0] = R * s + b * c + V * h + p * T, e[1] = R * r + b * d + V * k + p * m, e[2] = R * i + b * l + V * y + p * o, e[3] = R * a + b * L + V * M + p * x, R = n[4], b = n[5], V = n[6], p = n[7], e[4] = R * s + b * c + V * h + p * T, e[5] = R * r + b * d + V * k + p * m, e[6] = R * i + b * l + V * y + p * o, e[7] = R * a + b * L + V * M + p * x, R = n[8], b = n[9], V = n[10], p = n[11], e[8] = R * s + b * c + V * h + p * T, e[9] = R * r + b * d + V * k + p * m, e[10] = R * i + b * l + V * y + p * o, e[11] = R * a + b * L + V * M + p * x, R = n[12], b = n[13], V = n[14], p = n[15], e[12] = R * s + b * c + V * h + p * T, e[13] = R * r + b * d + V * k + p * m, e[14] = R * i + b * l + V * y + p * o, e[15] = R * a + b * L + V * M + p * x, e;
        }
      }, {
        key: "mul",
        value: function mul(e, t, n) {
        ...
        value: function translate(e, t, n) {
          ...
          if (t === e) e[12] = t[0] * s + t[4] * r + t[8] * i + t[12], e[13] = t[1] * s + t[5] * r + t[9] * i + t[13], e[14] = t[2] * s + t[6] * r + t[10] * i + t[14], e[15] = t[3] * s + t[7] * r + t[11] * i + t[15];else {
            var a = t[0],
              ...
              m = t[10],
              o = t[11];
            e[0] = a, e[1] = c, e[2] = d, e[3] = l, e[4] = L, e[5] = h, e[6] = k, e[7] = y, e[8] = M, e[9] = T, e[10] = m, e[11] = o, e[12] = a * s + L * r + M * i + t[12], e[13] = c * s + h * r + T * i + t[13], e[14] = d * s + k * r + m * i + t[14], e[15] = l * s + y * r + o * i + t[15];
          }
          return e;
        }
      }, {
        ...
        value: function rotate(e, t, n, s) {
          ...
          var d = Math.sin(n),
            ...
            N = i * a * L - r * d,
            v = a * a * L + l;
          return e[0] = h * I + T * F + R * S, e[1] = k * I + m * F + b * S, e[2] = y * I + o * F + V * S, e[3] = M * I + x * F + p * S, e[4] = h * z + T * Y + R * P, e[5] = k * z + m * Y + b * P, e[6] = y * z + o * Y + V * P, e[7] = M * z + x * Y + p * P, e[8] = h * O + T * N + R * v, e[9] = k * O + m * N + b * v, e[10] = y * O + o * N + V * v, e[11] = M * O + x * N + p * v, t !== e && (e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e;
        }
      }, {
        key: "rotateX",
        ...
        value: function fromRotationTranslation(e, t, n) {
          var s = t[0],
            ...
            o = a * d,
            x = a * l;
          return e[0] = 1 - (y + T), e[1] = h + x, e[2] = k - o, e[3] = 0, e[4] = h - x, e[5] = 1 - (L + T), e[6] = M + m, e[7] = 0, e[8] = k + o, e[9] = M - m, e[10] = 1 - (L + y), e[11] = 0, e[12] = n[0], e[13] = n[1], e[14] = n[2], e[15] = 1, e;
        }
      }, {
        key: "fromQuat2",
        ...
        value: function fromRotationTranslationScale(e, t, n, s) {
          var r = t[0],
            ...
            V = s[1],
            p = s[2];
          return e[0] = (1 - (M + m)) * b, e[1] = (k + R) * b, e[2] = (y - x) * b, e[3] = 0, e[4] = (k - R) * V, e[5] = (1 - (h + m)) * V, e[6] = (T + o) * V, e[7] = 0, e[8] = (y + x) * p, e[9] = (T - o) * p, e[10] = (1 - (h + M)) * p, e[11] = 0, e[12] = n[0], e[13] = n[1], e[14] = n[2], e[15] = 1, e;
        }
      }, {
        ...
        value: function fromQuat(e, t) {
          var n = t[0],
            ...
            m = i * c,
            o = i * d;
          return e[0] = 1 - h - M, e[1] = L + o, e[2] = k - m, e[3] = 0, e[4] = L - o, e[5] = 1 - l - M, e[6] = y + T, e[7] = 0, e[8] = k + m, e[9] = y - T, e[10] = 1 - l - h, e[11] = 0, e[12] = 0, e[13] = 0, e[14] = 0, e[15] = 1, e;
        }
      }, {
        key: "frustumNO",
        ...
        value: function lookAt(e, t, n, s) {
          var r = t[0],
            ...
            h = n[1],
            k = n[2];
          if (Math.abs(r - L) < 1e-6 && Math.abs(i - h) < 1e-6 && Math.abs(a - k) < 1e-6) return E.identity(e);
          var y = r - L,
            M = i - h,
            T = a - k,
          ...
          var b = M * R - T * x,
            V = T * o - y * R,
            p = y * x - M * o;
          return m = Math.sqrt(b * b + V * V + p * p), m ? (m = 1 / m, b *= m, V *= m, p *= m) : (b = 0, V = 0, p = 0), e[0] = o, e[1] = b, e[2] = y, e[3] = 0, e[4] = x, e[5] = V, e[6] = M, e[7] = 0, e[8] = R, e[9] = p, e[10] = T, e[11] = 0, e[12] = -(o * r + x * i + R * a), e[13] = -(b * r + V * i + p * a), e[14] = -(y * r + M * i + T * a), e[15] = 1, e;
        }
      }, {
        key: "targetTo",
    ...
    Q = /*#__PURE__*/function (_Float32Array7) {
      ...
      return _createClass(Q, [{
        ...
        value: function rotationTo(e, t, n) {
          var s = A.dot(t, n);
          return s < -0.999999 ? (A.cross(f(Q, W), f(Q, he), t), A.mag(f(Q, W)) < 1e-6 && A.cross(f(Q, W), f(Q, ye), t), A.normalize(f(Q, W), f(Q, W)), Q.setAxisAngle(e, f(Q, W), Math.PI), e) : s > .999999 ? (e[0] = 0, e[1] = 0, e[2] = 0, e[3] = 1, e) : (A.cross(f(Q, W), t, n), e[0] = f(Q, W)[0], e[1] = f(Q, W)[1], e[2] = f(Q, W)[2], e[3] = 1 + s, Q.normalize(e, e));
        }
      }, {
        key: "sqlerp",
  ...
  Le = new WeakMap(), ae = new WeakMap(), ce = new WeakMap(), U = new WeakMap(), W = new WeakMap(), he = new WeakMap(), ye = new WeakMap(), j(Q, Le, "zyx"), j(Q, ae, new Float32Array(4)), j(Q, ce, new Float32Array(4)), j(Q, U, new Float32Array(9)), j(Q, W, new Float32Array(3)), j(Q, he, new Float32Array([1, 0, 0])), j(Q, ye, new Float32Array([0, 1, 0]));
  var D = Q;
  D.set = w.set;
  D.add = w.add;
  D.lerp = w.lerp;
      ...
      return _createClass(Z, [{
        ...
        value: function rotateX(e, t, n) {
          var s = -t[0],
            ...
            y = l * a + L * i + c * r - d * s,
            M = L * a - c * s - d * r - l * i;
          return D.rotateX(e, t, n), s = e[0], r = e[1], i = e[2], a = e[3], e[4] = h * a + M * s + k * i - y * r, e[5] = k * a + M * r + y * s - h * i, e[6] = y * a + M * i + h * r - k * s, e[7] = M * a - h * s - k * r - y * i, e;
        }
      }, {
        key: "rotateY",
        value: function rotateY(e, t, n) {
          var s = -t[0],
            ...
            y = l * a + L * i + c * r - d * s,
            M = L * a - c * s - d * r - l * i;
          return D.rotateY(e, t, n), s = e[0], r = e[1], i = e[2], a = e[3], e[4] = h * a + M * s + k * i - y * r, e[5] = k * a + M * r + y * s - h * i, e[6] = y * a + M * i + h * r - k * s, e[7] = M * a - h * s - k * r - y * i, e;
        }
      }, {
        key: "rotateZ",
        value: function rotateZ(e, t, n) {
          var s = -t[0],
            ...
            y = l * a + L * i + c * r - d * s,
            M = L * a - c * s - d * r - l * i;
          return D.rotateZ(e, t, n), s = e[0], r = e[1], i = e[2], a = e[3], e[4] = h * a + M * s + k * i - y * r, e[5] = k * a + M * r + y * s - h * i, e[6] = y * a + M * i + h * r - k * s, e[7] = M * a - h * s - k * r - y * i, e;
        }
      }, {
        ...
        value: function multiply(e, t, n) {
          var s = t[0],
            ...
            o = n[2],
            x = n[3];
          return e[0] = s * x + a * T + r * o - i * m, e[1] = r * x + a * m + i * T - s * o, e[2] = i * x + a * o + s * m - r * T, e[3] = a * x - s * T - r * m - i * o, e[4] = s * L + a * c + r * l - i * d + h * x + M * T + k * o - y * m, e[5] = r * L + a * d + i * c - s * l + k * x + M * m + y * T - h * o, e[6] = i * L + a * l + s * d - r * c + y * x + M * o + h * m - k * T, e[7] = a * L - s * c - r * d - i * l + M * x - h * T - k * m - y * o, e;
        }
      }, {
        key: "mul",
        value: function mul(e, t, n) {
