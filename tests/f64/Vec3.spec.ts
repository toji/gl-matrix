...
import { Mat4, Vec3 } from '#gl-matrix/f64';

import type { Mat4Like, Vec3Like } from '#gl-matrix/types';

describe('Vec3', () => {
  describe('constructor', () => {
    it('should return Vec3(0, 0, 0) if called with no arguments', () => expect(new Vec3()).toBeVec(0, 0, 0));
  ...
  describe('static', () => {
    ...
    describe('transformMat4', () => {
      ...
      describe('with an identity', () => {
        ...
        it('should produce the input', () => expect(out).toBeVec(1, 2, 3));
        it('should return out', () => expect(result).toBe(out));
      });

      describe('with a lookAt', () => {
        beforeEach(() => {
          matr = Mat4.lookAt(new Mat4(), [5, 6, 7], [2, 6, 7], [0, 1, 0]);
          result = Vec3.transformMat4(out, vecA, matr);
        });
    ...
    /*
      ...
      describe('with 90deg about X', () => {
        beforeEach(() => { result = Vec3.transformMat3(out, [0,1,0], [1,0,0,0,0,1,0,-1,0]); });

        it('should produce correct output', () => expect(out).toBeVec(0,0,1));
      });

      describe('with 90deg about Y', () => {
        beforeEach(() => { result = Vec3.transformMat3(out, [1,0,0], [0,0,-1,0,1,0,1,0,0]); });

        it('should produce correct output', () => expect(out).toBeVec(0,0,-1));
      });

      describe('with 90deg about Z', () => {
        beforeEach(() => { result = Vec3.transformMat3(out, [1,0,0], [0,1,0,-1,0,0,0,0,1]); });

        it('should produce correct output', () => expect(out).toBeVec(0,1,0));
      });
      ...
      describe('with a lookAt normal matrix', () => {
        ...
        it('should rotate the input', () => expect(out).toBeVec( 0,0,1 ));
        it('should return out', () => expect(result).toBe(out));
      });
    });*/
    ...
    describe('abs', () => {
      beforeEach(() => { vecA = [-1, -2, -3]; });

      describe('with a separate output vector', () => {
        beforeEach(() => { result = Vec3.abs(out, vecA); });
      ...
      describe('when vecA is the output vector', () => {
        beforeEach(() => { result = Vec3.abs(vecA, vecA); });
