...
import type { Vec4Like } from '#gl-matrix/types';

describe('Vec4', () => {
  describe('constructor', () => {
    it('should return Vec4(0, 0, 0, 0) if called with no arguments', () => expect(new Vec4()).toBeVec(0, 0, 0, 0));
    ...
    it('should return Vec4(x, y, z, w) if called with (Float64Array([x, y, z, w]))', () => {
  ...
  describe('static', () => {
    ...
    describe('abs', () => {
      beforeEach(() => { vecA = [-1, -2, -3, -4]; });
      describe('with a separate output vector', () => {
        beforeEach(() => { result = Vec4.abs(out, vecA); });
      ...
      describe('when vecA is the output vector', () => {
        beforeEach(() => { result = Vec4.abs(vecA, vecA); });
    ...
    /*
      ...
      describe('when calling a function that does not modify the out variable', () => {
        beforeEach(() => { result = vec3.forEach(vecArray, 0, 0, 0, function(out, vec) {}); });
