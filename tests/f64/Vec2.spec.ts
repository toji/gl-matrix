...
describe('Vec2', () => {
  ...
  describe('constructor', () => {
    it('should return Vec2(0, 0) if called with no arguments', () => expect(new Vec2()).toBeVec(0, 0));
  ...
  describe('static methods', () => {
    describe('create', () => {
      it('should return Vec2(0, 0)', () => expect(Vec2.create()).toBeVec(0, 0));
    });
  ...
  describe('static', () => {
    ...
    /*
      ...
      describe('when calling a function that does not modify the out variable', () => {
        beforeEach(() => { result = Vec2.forEach(vecArray, 0, 0, 0, function(out, vec) {}); });
