...
export class ReadonlyMat2 extends mat2 {}
 ...
 * @returns {mat2} out
 */
export function set(out: mat2, m00: f64, m01: f64, m10: f64, m11: f64): mat2 {
  out[0] = m00;
  out[1] = m01;
  out[2] = m10;
  out[3] = m11;
 ...
 */
export function determinant(a: ReadonlyMat2): f64 {
 ...
 * @returns {mat2} out
 */
export function rotate(out: mat2, a: ReadonlyMat2, rad: f64): mat2 {
  let a0 = a[0],
    a1 = a[1],
    a2 = a[2],
    a3 = a[3];
 ...
 * @returns {mat2} out
 */
export function fromRotation(out: mat2, rad: f64): mat2 {
  let s = Math.sin(rad);
  let c = Math.cos(rad);
  out[0] = c;
  out[1] = s;
...
export function frob(a: ReadonlyMat2): f64 {
  return MathUtil.hypot(a[0], a[1], a[2], a[3]);
}
 ...
 * @returns {mat2} out
 */
export function multiplyScalar(out: mat2, a: ReadonlyMat2, b: f64): mat2 {
  out[0] = a[0] * b;
  out[1] = a[1] * b;
  out[2] = a[2] * b;
  out[3] = a[3] * b;
 ...
 * @returns {mat2} out
 */
export function multiplyScalarAndAdd(out: mat2, a: ReadonlyMat2, b: ReadonlyMat2, scale: f64): mat2 {
  out[0] = a[0] + b[0] * scale;
  out[1] = a[1] + b[1] * scale;
  out[2] = a[2] + b[2] * scale;
  out[3] = a[3] + b[3] * scale;
