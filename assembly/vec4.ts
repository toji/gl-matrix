 ...
 * @returns {vec4} out
 */
export function set(out: vec4, x: f64, y: f64, z: f64, w: f64): vec4 {
  out[0] = x;
  out[1] = y;
  out[2] = z;
  out[3] = w;
 ...
 * @returns {vec4} out
 */
export function scale(out: vec4, a: ReadonlyVec4, b: f64): vec4 {
  out[0] = a[0] * b;
  out[1] = a[1] * b;
  out[2] = a[2] * b;
  out[3] = a[3] * b;
 ...
 * @returns {vec4} out
 */
export function scaleAndAdd(out: vec4, a: ReadonlyVec4, b: ReadonlyVec4, scale: f64): vec4 {
  out[0] = a[0] + b[0] * scale;
  out[1] = a[1] + b[1] * scale;
  out[2] = a[2] + b[2] * scale;
  out[3] = a[3] + b[3] * scale;
 ...
 */
export function distance(a: ReadonlyVec4, b: ReadonlyVec4): f64 {
  let x = b[0] - a[0];
  let y = b[1] - a[1];
  let z = b[2] - a[2];
  let w = b[3] - a[3];
 ...
 */
export function squaredDistance(a: ReadonlyVec4, b: ReadonlyVec4): f64 {
  let x = b[0] - a[0];
  let y = b[1] - a[1];
  let z = b[2] - a[2];
  let w = b[3] - a[3];
 ...
 */
export function length(a: ReadonlyVec4): f64 {
  let x = a[0];
  let y = a[1];
  let z = a[2];
  let w = a[3];
 ...
 */
export function squaredLength(a: ReadonlyVec4): f64 {
  let x = a[0];
  let y = a[1];
  let z = a[2];
  let w = a[3];
 ...
 */
export function dot(a: ReadonlyVec4, b: ReadonlyVec4): f64 {
 ...
 * @returns {vec4} out
 */
export function lerp(out: vec4, a: ReadonlyVec4, b: ReadonlyVec4, t: f64): vec4 {
  let ax = a[0];
  let ay = a[1];
  let az = a[2];
  let aw = a[3];
 ...
 * @returns {vec4} out
 */
export function random(out: vec4, scale: f64): vec4 {
  scale = scale || 1.0;

  // Marsaglia, George. Choosing a Point from the Surface of a
  // Sphere. Ann. Math. Statist. 43 (1972), no. 2, 645--646.
  // http://projecteuclid.org/euclid.aoms/1177692644;
  var v1: f64, v2: f64, v3: f64, v4: f64;
  var s1: f64, s2: f64;
  do {
 ...
 */
// @ts-ignore
export const forEach: () => (a: vec4, stride: u16, offset: u16, count: u16, fn: (a: vec4, b: vec4, arg: IArguments) => void, arg: IArguments) => vec4 = (() => {
  let vec = create();
